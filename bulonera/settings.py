...
MIDDLEWARE = [
    ...
    'bulonera.middleware.ErrorLoggingMiddleware',
]
...
STATIC_URL = '/static/'
STATIC_ROOT = '/var/www/bulonera/bulonera/staticfiles/'
STATICFILES_DIRS = [
...
if DEBUG: #Ahora DEBUG = true ---> Estoy en desarrollo. 
    ...
    # Email para recibir los mensajes de contacto
    CONTACT_EMAIL = 'contacto@buloneraalvear.online' #'tucorreo@dominio.
